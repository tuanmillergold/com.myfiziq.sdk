...
module.exports = {
    ...
    mfzUserIdpLogin: function (optional_email, password, success_cb, error_cb) {
        exec(success_cb, error_cb, 'MyFiziq', 'mfzUserIdpLogin', [optional_email, password]);
    },
    ...
    mfzAvatarDisplayNative: function (id, success_cb, error_cb) {
        exec(success_cb, error_cb, 'MyFiziq', 'mfzAvatarDisplayNative', [id]);
    }
};
